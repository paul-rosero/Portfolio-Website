...
const workArray = [
    ...
    { startDate: "05/2009", endDate: "06/2011", companyName: "OHEKA Castle", position: "Waiter", description: ["In charge of a group of employees to set up and break down the decorations for the party.", "", "", ""] }

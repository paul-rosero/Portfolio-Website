...
const workArray = [
    ...
    { startDate: "05/2009", endDate: "06/2011", companyName: "OHEKA Castle", position: "Waiter", description: ["In charge of a group of employees to set up and break down the decorations for the party.", "Started as a waiter and was eventually promoted to become one of 3 manager in charge of setting up for the party.", "", ""] }
